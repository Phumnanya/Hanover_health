//description for each disease
  const diseaseDescriptions: Record<string, string> = {
    hepatitis:`
    Hepatitis is an inflammation of the liver that is caused by a variety of infectious viruses and non-infectious agents 
    ...
    yellow_fever:`Yellow fever is a viral disease that is transmitted to humans by the bites of infected mosquitoes. It is prone to epidemics and is preventable with a vaccine. 
...
export default diseaseDescriptions;
